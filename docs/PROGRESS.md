...
| Frontend | 21 feature folders, 20 screens, **374 tests across 45 files** (296, then 308, 345, 359 and 366, earlier on 2026-08-18). The count was 366 here until 2026-08-20 and the tree held 374 on the day it was written: the eight are a stale figure being corrected, not tests the split added, which moved 374 from 40 files into 45 without changing one of their names. Types generated from the backend's OpenAPI document and checked against every hand-written schema at compile time |
